...
class Question(models.Model):
    ...
    # Russian-only Storyteller. No db_index: a 2-value column is too low-cardinality
    # for an index to beat a scan. Part of content_hash, so both languages coexist.
